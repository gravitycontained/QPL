...
namespace qgl {
	...
	void qgl::detail::va_primitive_type::set_primitive_type(qgl::primitive_type primitive_type) {
		this->primitive_type = primitive_type;
	}
	qgl::primitive_type qgl::detail::va_primitive_type::get_primitive_type() const {
