...
namespace qpl {
    ...
    namespace filesys {
        ...
        public:
            ...
            QPLDLL path get_parent_directory() const;
            ...
            QPLDLL void rename(const qpl::filesys::path& new_name) const;
            ...
            QPLDLL qpl::size directory_levels() const;
            QPLDLL path directory_at_level(qpl::u32 index) const;
            ...
            QPLDLL qpl::filesys::paths list_current_directory_recursively() const;
            QPLDLL void print_current_directory() const;
            QPLDLL void print_current_directory_recursively() const;

            QPLDLL qpl::filesys::paths make_directory_range() const;
            QPLDLL qpl::filesys::paths make_directory_range_recursively() const;

            QPLDLL qpl::size last_common_branch(const qpl::filesys::path& path);
        ...
        public:
            ...
            QPLDLL void list_remove_where_extension_doesnt_equal(const std::string& extension);
            ...
            QPLDLL void list_remove_where_extension_doesnt_contain(const std::string& str);
            ...
            QPLDLL void list_remove_where_extension_doesnt_match(const std::regex& regex);
            ...
            QPLDLL void list_remove_where_name_doesnt_equal(const std::string& name);
            ...
            QPLDLL void list_remove_where_name_doesnt_contain(const std::string& name);
            ...
            QPLDLL void list_remove_where_name_doesnt_match(const std::regex& regex);
            ...
            QPLDLL void list_remove_where_file_name_doesnt_equal(const std::string& file_name);
            ...
            QPLDLL void list_remove_where_file_name_doesnt_contain(const std::string& file_name);
            ...
            QPLDLL void list_remove_where_file_name_doesnt_match(const std::regex& regex);
            ...
            QPLDLL void list_remove_where_extension_doesnt_equal(const std::string_view& extension);
            ...
            QPLDLL void list_remove_where_extension_doesnt_contain(const std::string_view& str);
            ...
            QPLDLL void list_remove_where_name_doesnt_equal(const std::string_view& name);
            ...
            QPLDLL void list_remove_where_name_doesnt_contain(const std::string_view& name);
            ...
            QPLDLL void list_remove_where_file_name_doesnt_equal(const std::string_view& file_name);
            ...
            QPLDLL void list_remove_where_file_name_doesnt_contain(const std::string_view& file_name);
            ...
            QPLDLL void list_remove_where_extension_doesnt_equal(const char* extension);
            ...
            QPLDLL void list_remove_where_extension_doesnt_contain(const char* str);
            ...
            QPLDLL void list_remove_where_name_doesnt_equal(const char* name);
            ...
            QPLDLL void list_remove_where_name_doesnt_contain(const char* name);
            ...
            QPLDLL void list_remove_where_file_name_doesnt_equal(const char* file_name);
            ...
            QPLDLL void list_remove_where_file_name_doesnt_contain(const char* file_name);
        ...
        QPLDLL qpl::filesys::paths list_directory_recursively(const qpl::filesys::path& path);
        QPLDLL qpl::filesys::paths list_current_directory_recursively();
        ...
        QPLDLL qpl::filesys::path get_parent_directory(const qpl::filesys::path& path);
        ...
        QPLDLL void partially_rename_all(const qpl::filesys::paths& files, const std::string& regex, const std::string& replace);
        QPLDLL void partially_rename_all(const qpl::filesys::path& path, const std::string& regex, const std::string& replace);
