...
namespace qsf {
	...
	struct text_stream {
		...
		QPLDLL sf::Sprite& get_sprite(qpl::size line, qpl::size index);
		QPLDLL const sf::Sprite& get_sprite(qpl::size line, qpl::size index) const;
	...
	public:
		...
		qsf::vector2f get_knob_position() const {
